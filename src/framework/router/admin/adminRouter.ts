...
router.get("/paginationTutors", jwtAuth , (req, res, next)=> adminApplicationController.paginatedTutors(req, res, next))
...
router.get("/paginatedCourse" , (req, res, next)=> courseController.paginatedCourse(req, res, next))
